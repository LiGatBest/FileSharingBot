...
# My Name Is LiGat 
# Recode by itself
# t.me/TekanSiniLah & t.me/Unlimited4u
...
class Bot(Client):
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/IWasNotABot untuk Bantuan"
                )
                sys.exit()
        if FORCE_SUB_GROUP:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/TekanSiniLah untuk Bantuan"
                )
                sys.exit()
        try:
        ...
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! 🔥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/TekanSiniLah"
        )
